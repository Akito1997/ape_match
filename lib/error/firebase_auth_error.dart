  ...
  static FirebaseAuthResultStatus handleException(FirebaseAuthException e) {
    ...
    switch (e.code) {
      ...
      case 'network-request-failed':
        result = FirebaseAuthResultStatus.NetWorkRequestFailed;
        break;
      case 'weak-password':
  ...
  static String exceptionMessage(FirebaseAuthResultStatus result) {
    ...
    switch (result) {
      ...
      case FirebaseAuthResultStatus.EmailAlreadyExists:
        ...
        break;
      case FirebaseAuthResultStatus.NetWorkRequestFailed:
        message = '通信環境が悪いです。通信環境の良好な場所でもう一度試してみてください。';
        break;
      case FirebaseAuthResultStatus.WeakPassword:
        message = 'パスワードは6文字以上してください。';
        break;
      default:
